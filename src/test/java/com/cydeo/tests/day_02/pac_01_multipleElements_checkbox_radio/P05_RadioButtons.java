...
public class P05_RadioButtons {
    ...
    void test1() {
       ...
       BrowserType chromium = playwright.chromium();
        ...
        System.out.println("hockey.isChecked() = " + hockey.isChecked());
        hockey.check();
        System.out.println("hockey.check()");

        BrowserUtils.sleepWithThread(3);
        System.out.println("hockey.isChecked() = " + hockey.isChecked());

        System.out.println("page.locator(\"#red\").isChecked() = " + page.locator("#red").isChecked());
        page.locator("#red").check();
        System.out.println("page.locator(\"#red\").isChecked() = " + page.locator("#red").isChecked());
